                        ...
                        <div class="card card-primary card-outline">
                            <div class="card-body box-profile">
                                ...
                                <ul class="list-group list-group-unbordered mb-3">
                                    ...
                                    <li class="list-group-item">
                                        <b>Trạng thái</b> <a class="float-right"><?php echo $user->status ? '<span style="color:green;">Bình thường</span>' : '<span style="color:red;">Đã bị xóa</span>' ?></a>
                                    </li>
                                </ul>
                            </div>
                            <!-- /.card-body -->
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="active tab-pane" id="infoUser">
                                        <ul class="list-group">
                                            <li class="list-group-item">
                                                <div class="row">
                                                    <div class="col-sm-2"><i class="fas fa-user mr-1" style="margin-left: 2px"></i><b> Họ
                                                            tên: </b></div>
                                                    <div
                                            ...
                                            <li class="list-group-item">
                                                <div class="row">
                                                    <div class="col-sm-2"><i class="fas fa-venus-mars mr-1" style="margin-left: -2px"></i><b> Giới
                                                            tính: </b></div>
                                            ...
                                            <li class="list-group-item">
                                                <div class="row">
                                                    <div class="col-sm-2"><i class="fas fa-birthday-cake" style="margin-left: 1px; margin-right: 5px"></i><b> Ngày
                                                            sinh: </b></div>
                                                    <div
                                            ...
                                            <li class="list-group-item">
                                                <div class="row">
                                                    <div class="col-sm-2"><i class="fas fa-map-marker-alt mr-1" style="margin-left: 3px"></i><b>
                                                            Địa chỉ: </b></div>
                        ...
                        <span class="bg-success">
                          3 Jan. 2014
                                    ...
                                    <div class="tab-pane" id="updateInfoUser">
                                        <form class="form-horizontal" action="" method="post" id="formUpdateInfoUser" enctype="multipart/form-data">
                                            @csrf
                                                ...
                                                <div class="form-group col-sm-10">
                                                    <div class="input-group date" id="birthdayDate"
                                                        ...
                                                        <input type="text" class="form-control datetimepicker-input"
                                                               id="birthday" name="birthday" data-target="#birthdayDate"
                                                               data-toggle="datetimepicker" data-min="01/01/1950" value="{{date('d/m/Y', strtotime($user->birthday))}}"/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
